<template>
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        ...
        <form @submit.prevent="login">
          <!-- <div class="d-flex flex-row align-items-center justify-content-center">
            <h2 class="lead fw-normal mb-0 me-3">Login</h2>
          ...
          <div v-if="isInvalid" class="divider d-flex align-items-center my-4">
            <p class="text-center fw-bold mx-3 mb-0" style="color: red">Email or Password Invalid</p>
          </div>
  ...
  <div
    ...
    <div class="text-white mb-3 mb-md-0">
      Copyright © 2024. By Riki Alparisi.
    </div>
    <!-- Copyright -->
